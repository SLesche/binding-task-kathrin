% This function reads the keyboard and detects wether space bar was hit
...
while validKey == 0
    ...
    if keyIsDown % As soon as a key is pressed check whether it is a valid key
        ...
        if strcmp(pressedKey,expinfo.StartKey) % right key pressed
...
% or backward and
if  strcmp(pressedKey,expinfo.RightKey)
    response = 1;
end
